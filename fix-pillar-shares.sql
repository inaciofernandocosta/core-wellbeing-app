-- ========================================
-- FIX: Remove políticas existentes e recria tudo
-- ========================================
-- Execute este SQL se você já tentou criar antes
-- ========================================
...
-- 5. Criar políticas para pillar_shares
...
-- 7. Trigger (DROP e CREATE para garantir)
DROP TRIGGER IF EXISTS update_pillar_shares_updated_at ON pillar_shares;
...
-- 8. CRÍTICO: Permitir acesso público aos pilares compartilhados
-- Esta política permite que QUALQUER PESSOA veja pilares que têm compartilhamentos
...
-- 9. Permitir edição de pilares compartilhados com permissão edit
...
-- ========================================
-- PRONTO! Sistema de compartilhamento configurado
-- ========================================
-- Agora teste: https://lifosmvp.netlify.app
-- ========================================
